            ...
            <a style={{ color: 'black' }}>
              <div className='col-names'>
                ...
                <p>
                  ...
                  to practice. Whether you’re a morning bird or a night owl,
                  <span id='dots4'>...</span>
                  <span id='more4'>
                    the ability to roll out your mat at any given time offers a
                    great amount of freedom and allows you to commit to your
                    practice in a way that is simple and easy.Online yoga offers
                    an abundance of options and solutions for the modern-day
                    yogi. Share the many physical and mental benefits of Yoga
                    with your family, friends, coworkers or neighbors.
                  </span>
                  <b
                    style={{
                      fontWeight: 'bold',
            ...
            <Link href='/services/#yogaforbeginners'>
              <a style={{ color: 'black' }}>
                ...
                <p>
                  ...
                  <span id='dots1'>...</span>
                  <span id='more1'>
                    nner, or have tried yoga in the past and are ready to really
                    get going, these classes will pave the way. These beginners
                    class is designed for everyone and for everybody, so there’s
                    no need to be wary if you have no previous yoga experience.
                  </span>
                  <b
                    style={{
                      fontWeight: 'bold',
              ...
              <a style={{ color: 'black' }}>
                ...
                <p>
                  ...
                  <span id='more2'>
                    ...
                    (Pranayama) limb in the Eight Limbs of Yoga. Hatha Yoga
                    focuses on breathing and postures which are held for a while
                    to benefit from their healing power. Because Hatha yoga’s
                    pace is slow and gentle, it is an ideal starting place for
                ...
                <p>
                  ...
                  <span id='more3'>
                    ...
                    <ol style={{ textAlign: 'start', marginTop: '1px' }}>
                      ...
                      <li>
                        Tailor The Class To Your Limitations, Injuries, or
                        Health Concerns Book Your Private Yoga Class Today.
                      </li>
                    </ol>
                  </span>
                  <b
